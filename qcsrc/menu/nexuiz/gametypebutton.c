...
void NexuizGametypeButton_configureNexuizGametypeButton(entity me, float theGroup, string theCvar, string theText)
{
	if(theCvar)
	{
		me.cvarName = theCvar;
...
void NexuizGametypeButton_setChecked(entity me, float val)
{
	if(val != me.checked)
	{
		me.checked = val;
...
void NexuizGametypeButton_loadCvars(entity me)
{
	if not(me.cvarName)
		return;
...
void NexuizGametypeButton_saveCvars(entity me)
{
	if not(me.cvarName)
		return;
