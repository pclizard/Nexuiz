...
void NexuizEffectsSettingsTab_fill(entity me)
{
	entity e, s;
	float n;
	me.TR(me);
	...
	me.TR(me);
	me.TR(me);
		me.TD(me, 1, 1, e = makeNexuizTextLabel(0, "Texture resolution:"));
		me.TD(me, 1, 2, e = makeNexuizPicmipSlider());
			if(cvar("developer"))
		...
		me.TDempty(me, 0.2);
		{
			...
			switch(f)
			{
				case 0:
					break;
				case 1:
					me.TD(me, 1, 2.8, e = makeNexuizCheckBox(1, "r_texture_dds_load", "Avoid lossy texture compression"));
					break;
				case 2:
					me.TD(me, 1, 2.8, e = makeNexuizCheckBox(1, "r_texture_dds_load", "Avoid lossy texture compression"));
	...
	me.TR(me);
		...
		me.TD(me, 1, 2, e = makeNexuizSlider(0.2, 1.0, 0.1, "cl_particles_quality"));
	me.TR(me);
	...
	me.TR(me);
		...
		me.TD(me, 1, 2, e = makeNexuizCheckBoxEx(2, 0, "r_hdr", "High Dynamic Range (HDR)"));
