...
void NexuizResolutionSlider_addResolution(entity me, float w, float h, float pixelheight)
{
...
void NexuizResolutionSlider_configureNexuizResolutionSlider(entity me)
{
	float i;
	vector r0, r;
...
void NexuizResolutionSlider_loadCvars(entity me)
{
...
void NexuizResolutionSlider_saveCvars(entity me)
{
