#ifdef INTERFACE
CLASS(NexuizHUDInfoMessagesDialog) EXTENDS(NexuizRootDialog)
	METHOD(NexuizHUDInfoMessagesDialog, fill, void(entity))
	ATTRIB(NexuizHUDInfoMessagesDialog, title, string, "Info Messages Panel")
	ATTRIB(NexuizHUDInfoMessagesDialog, color, vector, SKINCOLOR_DIALOG_TEAMSELECT)
	ATTRIB(NexuizHUDInfoMessagesDialog, intendedWidth, float, 0.4)
	ATTRIB(NexuizHUDInfoMessagesDialog, rows, float, 15)
	ATTRIB(NexuizHUDInfoMessagesDialog, columns, float, 4)
	ATTRIB(NexuizHUDInfoMessagesDialog, name, string, "HUDinfomessages")
ENDCLASS(NexuizHUDInfoMessagesDialog)
#endif

#ifdef IMPLEMENTATION
void NexuizHUDInfoMessagesDialog_fill(entity me)
{
	entity e;
	...
	me.TR(me);
		me.TD(me, 1, 3, e = makeNexuizCheckBox(0, "hud_panel_infomessages", "Enable panel"));
	me.TR(me);
	...
	me.TR(me);
		...
		me.TD(me, 1, 1.2, e = makeNexuizTextLabel(0, "Padding:"));
			me.TD(me, 1, 2.6, e = makeNexuizTextSlider(strzone(strcat("hud_panel_", panelname, "_bg_padding"))));
				...
				e.configureNexuizTextSliderValues(e);
	me.TR(me);
		me.TD(me, 1, 2, e = makeNexuizTextLabel(0, "Info messages:"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 3, e = makeNexuizCheckBox(0, "hud_panel_infomessages_flip", "Flip align"));
}
#endif
