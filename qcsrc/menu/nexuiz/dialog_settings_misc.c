...
void NexuizMiscSettingsTab_fill(entity me)
{
	entity e;
	entity sk;
	...
	me.TR(me);
		...
		me.TD(me, 1, 2.8/2, e = makeNexuizSlider(0.2, 2, 0.2, "cl_showacceleration_scale"));
			setDependent(e, "cl_showacceleration", 1, 1);
	me.TR(me);
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2.8, e = makeNexuizCheckBox(0, "cl_maxfps_alwayssleep", "Minimize input latency"));
	me.TR(me);
	me.TR(me);
		me.TDempty(me, 0.5);
