...
void NexuizListBox_configureNexuizListBox(entity me)
{
	me.configureListBox(me, me.scrollbarWidth, 1); // item height gets set up later
}
void NexuizListBox_resizeNotify(entity me, vector relOrigin, vector relSize, vector absOrigin, vector absSize)
{
	me.itemHeight = me.rowsPerItem * me.fontSize / absSize_y;
	SUPER(NexuizListBox).resizeNotify(me, relOrigin, relSize, absOrigin, absSize);
}
#endif
