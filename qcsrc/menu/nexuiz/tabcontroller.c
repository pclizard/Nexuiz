...
void NexuizTabController_configureNexuizTabController(entity me, float theRows)
{
	me.rows = theRows;
}
entity NexuizTabController_makeTabButton(entity me, string theTitle, entity tab)
{
	entity b;
	if(me.rows != tab.rows)
