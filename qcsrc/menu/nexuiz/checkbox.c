...
void NexuizCheckBox_configureNexuizCheckBox(entity me, float theYesValue, float theNoValue, string theCvar, string theText)
{
...
void NexuizCheckBox_setChecked(entity me, float val)
{
	if(val != me.checked)
	{
		me.checked = val;
...
void NexuizCheckBox_loadCvars(entity me)
{
	float m, d;
...
void NexuizCheckBox_saveCvars(entity me)
{
	if not(me.cvarName)
		return;
