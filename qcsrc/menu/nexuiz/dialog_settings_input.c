...
void NexuizInputSettingsTab_fill(entity me)
{
	entity e;
	entity kb;
	...
	me.TR(me);
		me.TD(me, me.rows - 2, 3.3, kb = makeNexuizKeyBinder());
	me.gotoRC(me, me.rows - 1, 0);
	me.TR(me);
		me.TD(me, 1, 1.1, e = makeNexuizButton("Change key...", '0 0 0'));
			e.onClick = KeyBinder_Bind_Change;
			e.onClickEntity = kb;
			kb.keyGrabButton = e;
		me.TD(me, 1, 1.1, e = makeNexuizButton("Edit...", '0 0 0'));
		...
		me.TD(me, 1, 1.1, e = makeNexuizButton("Clear", '0 0 0'));
			e.onClick = KeyBinder_Bind_Clear;
			e.onClickEntity = kb;

	me.gotoRC(me, 0, 3.5); me.setFirstColumn(me, me.currentColumn);
		me.TD(me, 1, 1, e = makeNexuizTextLabel(0, "Sensitivity:"));
		me.TD(me, 1, 0.64, e = makeNexuizInputBox(0, "sensitivity"));
	me.TR(me);
	...
	me.TR(me);
		me.TD(me, 1, 3, e = makeNexuizCheckBox(0, "m_accelerate", "Mouse Accel"));
	me.TR(me);
