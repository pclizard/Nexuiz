...
void NexuizSliderCheckBox_configureNexuizSliderCheckBox(entity me, float theOffValue, float isInverted, entity theControlledSlider, string theText)
{
...
void NexuizSliderCheckBox_draw(entity me)
{
	...
	SUPER(NexuizSliderCheckBox).draw(me);
}
void NexuizSliderCheckBox_setChecked(entity me, float val)
{
	if(me.checked == val)
		return;
	me.checked = val;
