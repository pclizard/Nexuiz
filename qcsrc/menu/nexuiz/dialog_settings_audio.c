...
void NexuizAudioSettingsTab_fill(entity me)
{
	entity e, s, sl;

	me.TR(me);
		s = makeNexuizDecibelsSlider(-20, 0, 0.5, "mastervolume");
	...
	me.TR(me);
		...
		me.TD(me, 1, 0.8, e = makeNexuizSliderCheckBox(-1000000, 1, s, "Music:"));
		me.TD(me, 1, 2, s);
	me.TR(me);
		me.TDempty(me, 0.2);
	...
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 0.8, e = makeNexuizTextLabel(0, "Frequency:"));
		me.TD(me, 1, 2, sl);
	me.TR(me);
	me.TR(me);
