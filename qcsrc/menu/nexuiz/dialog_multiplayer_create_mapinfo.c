...
CLASS(NexuizMapInfoDialog) EXTENDS(NexuizDialog)
	...
	ATTRIB(NexuizMapInfoDialog, typeKeepawayLabel, entity, NULL)
...
void NexuizMapInfoDialog_loadMapInfo(entity me, float i, entity mlb)
{
...
void NexuizMapInfoDialog_fill(entity me)
{
	entity e;
	float w, wgt;
	me.TR(me);
	...
	me.TR(me);
		...
		me.TD(me, 1, wgt, e = makeNexuizTextLabel(0, "Keepaway"));
