#ifdef INTERFACE
CLASS(NexuizHUDRaceTimerDialog) EXTENDS(NexuizRootDialog)
	METHOD(NexuizHUDRaceTimerDialog, fill, void(entity))
	ATTRIB(NexuizHUDRaceTimerDialog, title, string, "Race Timer Panel")
	ATTRIB(NexuizHUDRaceTimerDialog, color, vector, SKINCOLOR_DIALOG_TEAMSELECT)
	ATTRIB(NexuizHUDRaceTimerDialog, intendedWidth, float, 0.4)
	ATTRIB(NexuizHUDRaceTimerDialog, rows, float, 15)
	ATTRIB(NexuizHUDRaceTimerDialog, columns, float, 4)
	ATTRIB(NexuizHUDRaceTimerDialog, name, string, "HUDracetimer")
ENDCLASS(NexuizHUDRaceTimerDialog)
#endif

#ifdef IMPLEMENTATION
void NexuizHUDRaceTimerDialog_fill(entity me)
{
	entity e;
	...
	me.TR(me);
		me.TD(me, 1, 3, e = makeNexuizCheckBox(0, "hud_panel_racetimer", "Enable panel"));
	me.TR(me);
