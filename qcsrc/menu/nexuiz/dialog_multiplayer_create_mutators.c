...
void NexuizMutatorsDialog_showNotify(entity me)
{
	loadAllCvars(me);
}
...
string NexuizMutatorsDialog_toString(entity me)
{
	string s;
	s = "";
	if(cvar("g_dodging"))
...
void NexuizMutatorsDialog_fill(entity me)
{
	entity e, s, w;
	float i, j;
	string str, hstr;
	...
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNexuizCheckBox(0, "g_dodging", "Dodging"));
	me.TR(me);
		me.TDempty(me, 0.2);
	...
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNexuizCheckBox(0, "g_rocket_flying", "Rocket Flying"));
	me.TR(me);
		me.TDempty(me, 0.2);
	...
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2, e = makeNexuizRadioButton(1, "g_nix", string_null, "NIX"));
	me.TR(me);
		me.TDempty(me, 0.4);
		me.TD(me, 1, 1, e = makeNexuizCheckBox(0, "g_nix_with_laser", "with laser"));
...
void NexuizMutatorsDialog_close(entity me)
{
	if(me.refilterEntity)
		me.refilterEntity.refilter(me.refilterEntity);
	SUPER(NexuizMutatorsDialog).close(me);
}
#endif
