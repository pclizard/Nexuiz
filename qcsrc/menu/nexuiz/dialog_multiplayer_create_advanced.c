...
void NexuizAdvancedDialog_showNotify(entity me)
{
	loadAllCvars(me);
}

void NexuizAdvancedDialog_fill(entity me)
{
	entity e;
	me.TR(me);
...
void NexuizAdvancedDialog_close(entity me)
{
	if(me.refilterEntity)
		me.refilterEntity.refilter(me.refilterEntity);
	SUPER(NexuizAdvancedDialog).close(me);
}
#endif
