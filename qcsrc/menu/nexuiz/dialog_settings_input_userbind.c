...
void NexuizUserbindEditDialog_loadUserBind(entity me, string theName, string theCommandPress, string theCommandRelease)
{
...
void NexuizUserbindEditDialog_fill(entity me)
{
	entity e;
	me.TR(me);
