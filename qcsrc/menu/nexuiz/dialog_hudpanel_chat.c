#ifdef INTERFACE
CLASS(NexuizHUDChatDialog) EXTENDS(NexuizRootDialog)
	METHOD(NexuizHUDChatDialog, fill, void(entity))
	ATTRIB(NexuizHUDChatDialog, title, string, "Chat Panel")
	ATTRIB(NexuizHUDChatDialog, color, vector, SKINCOLOR_DIALOG_TEAMSELECT)
	ATTRIB(NexuizHUDChatDialog, intendedWidth, float, 0.4)
	ATTRIB(NexuizHUDChatDialog, rows, float, 15)
	ATTRIB(NexuizHUDChatDialog, columns, float, 4)
	ATTRIB(NexuizHUDChatDialog, name, string, "HUDchat")
ENDCLASS(NexuizHUDChatDialog)
#endif

#ifdef IMPLEMENTATION
void NexuizHUDChatDialog_fill(entity me)
{
	entity e;
	...
	me.TR(me);
		me.TD(me, 1, 3, e = makeNexuizCheckBox(0, "hud_panel_chat", "Enable panel"));
	me.TR(me);
	...
	me.TR(me);
		...
		me.TD(me, 1, 1.2, e = makeNexuizTextLabel(0, "Padding:"));
			me.TD(me, 1, 2.6, e = makeNexuizTextSlider(strzone(strcat("hud_panel_", panelname, "_bg_padding"))));
				...
				e.configureNexuizTextSliderValues(e);
	me.TR(me);
		me.TD(me, 1, 2, e = makeNexuizTextLabel(0, "Chat entries:"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 1.2, e = makeNexuizTextLabel(0, "Chat size:"));
		me.TD(me, 1, 2.6, e = makeNexuizSlider(6, 20, 1, "con_chatsize"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 1.2, e = makeNexuizTextLabel(0, "Chat lifetime:"));
		me.TD(me, 1, 2.6, e = makeNexuizSlider(5, 60, 5, "con_chattime"));
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 3, e = makeNexuizCheckBox(0, "con_chatsound", "Chat beep sound"));
}
#endif
