...
void XonoticNetworkSettingsTab_fill(entity me)
{
	...
	me.TR(me);
		...
		me.TD(me, 1, 0.64, e = makeXonoticInputBox(0, "_cl_rate"));
    me.TR(me);
		me.TD(me, 1, 1, e = makeXonoticTextLabel(0, "Input packets/s:"));
		me.TD(me, 1, 0.64, e = makeXonoticInputBox(0, "cl_netfps"));
	me.TR(me);
	me.TR(me);
	...
	me.TR(me);
		...
		me.TD(me, 1, 0.64, e = makeXonoticInputBox(0, "cl_curl_maxspeed"));
	me.TR(me);
	me.TR(me);
